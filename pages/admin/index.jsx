...
const Index = ({ orders, products }) => {
  // remember that file name begin in lower case, but the main function name, if it's a component, has to begin in upper case
...
export const getServerSideProps = async (ctx) => {
  ...
  if (myCookie.token !== process.env.TOKEN) {
    // if myCookie doesn't equal to token...
    // ... just block this process here and don't call any api request here
    return {
      redirect: {
        // this is a method for Next.js that we can use redirect and inside this object we can set:
