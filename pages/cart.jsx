...
const Cart = () => {
  ...
  const createOrder = async (data) => {
    try {
      const res = await axios.post("http://0.0.0.0:3000/api/orders", data); // what API use to create the order and the data sent
    ...
    <div className={styles.container}>
      ...
      <div className={styles.right}>
        <div className={styles.wrapper}>
          ...
          <div className={styles.totalText}>
            <b className={styles.totalTextTitle}>IVA 21%:</b> Rs. {cart.total * 0.21}
          </div>
          <div className={styles.totalText}>
            <b className={styles.totalTextTitle}>Discount:</b> Rs. 0.00
          </div>
          <div className={styles.totalText}>
            <b className={styles.totalTextTitle}>Total:</b> Rs. {cart.total * 1.21}
          </div>
