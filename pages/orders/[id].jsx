    ...
    <div className={styles.container}>
      ...
      <div className={styles.right}>
        <div className={styles.wrapper}>
          ...
          <div className={styles.totalText}>
            <b className={styles.totalTextTitle}>IVA 21%:</b> Rs.{order.total * 0.21}
          </div>
          <div className={styles.totalText}>
            <b className={styles.totalTextTitle}>Discount:</b> Rs. 0,00
          </div>
          <div className={styles.totalText}>
            <b className={styles.totalTextTitle}>Total:</b> Rs.{order.total * 1.21}
          </div>
...
export const getServerSideProps = async ({ params }) => {
  const res = await axios.get(`http://0.0.0.0:3000/api/orders/${params.id}`); // we're taking the id from parameters and making this api request
  return {
